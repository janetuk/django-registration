...
urlpatterns = [
    url(r'^activate/complete/$',
        TemplateView.as_view(template_name='/application/source/src/django-registration/registration/templates/registration/activation_complete.html'),
    ...
    url(r'^register/complete/$',
        TemplateView.as_view(template_name='/application/source/src/django-registration/registration/templates/registration/registration_complete.html'),
